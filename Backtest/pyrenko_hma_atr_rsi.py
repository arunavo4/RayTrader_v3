...
def get_hma(price, timeperiod=14):
    ...
    return (talib.WMA(2*talib.WMA(price, timeperiod=math.floor(timeperiod/2))-talib.WMA(price, timeperiod=timeperiod),timeperiod=math.sqrt(timeperiod)))
...
datapath = ('G:\AI Trading\Code\RayTrader_v3\Backtest\RELIANCE-EQ.csv')
...
print('Set brick size to optimal: ', renko_obj_sfo.set_brick_size(auto = False, brick_size = 2.1817))
...
hma = get_hma(renko_obj_sfo.get_close_price())
