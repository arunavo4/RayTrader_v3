...
#
# model.add(tf.keras.layers.GRU(n_neurons,input_shape=(x_train.shape[1],x_train.shape[2]),activation='linear',
#                                batch_input_shape=(batch_size,x_train.shape[1],x_train.shape[2]),
#                                kernel_initializer='he_normal', return_sequences=True,
#                                stateful=False))
# model.add(tf.keras.layers.LeakyReLU(alpha=0.3))
# model.add(tf.keras.layers.Dropout(0.25))
# model.add(tf.keras.layers.GRU(n_neurons,activation='linear',
#                                kernel_initializer='he_normal', return_sequences=True,
#                                stateful=False))
# model.add(tf.keras.layers.LeakyReLU(alpha=0.3))
# model.add(tf.keras.layers.Dropout(0.25))
...
checkpoint_callback = tf.keras.callbacks.ModelCheckpoint('stateful_BiGRU_pretrained.hdf5'
