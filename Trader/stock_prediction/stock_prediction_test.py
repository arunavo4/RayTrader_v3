...
export_dir = 'G:\AI Trading\Code\RayTrader_v3\Trader\stock_prediction\model\model_15'
...
x_test = min_max_scaler.inverse_transform(x_test[:,18,3].reshape(-1, 1))
...
# plotting the graph
comp = pd.DataFrame({'Column1': y_test[:-1, 3], 'Column2': y_test_pred[:-1, 3]})
fig = plt.figure(figsize=(10, 5))
fig.suptitle('model_15')
