...
export_dir = 'G:\AI Trading\Code\RayTrader_v3\Trader\stock_prediction\model\model_t2'
...
def load_data(stock, seq_len):
    ...
    x_train = data[:train_set_size, :-2, :]
    y_train = data[:train_set_size, -1, :]
    x_valid = data[train_set_size:train_set_size + valid_set_size, :-2, :]
    y_valid = data[train_set_size:train_set_size + valid_set_size, -1, :]
    x_test = data[train_set_size + valid_set_size:, :-2, :]
...
x_test = min_max_scaler.inverse_transform(x_test[:,17,3].reshape(-1, 1))
y_test = min_max_scaler.inverse_transform(y_test)
y_test_pred = min_max_scaler.inverse_transform(y_test_pred)

print("Input data: ",x_test[-10:])

print("Actual: ", y_test[-10:,3])
print("Predicated: ",y_test_pred[-10:,3])
# plotting the graph
