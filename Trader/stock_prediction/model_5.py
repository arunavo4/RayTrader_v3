...
file_name = 'G:\AI Trading\Code\RayTrader_v3\Trader\stock_prediction\data\data_5\ADANIPORTS-EQ.csv'
export_dir = 'G:\AI Trading\Code\RayTrader_v3\Trader\stock_prediction\model\model_5'
