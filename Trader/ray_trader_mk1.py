"""
#   Trader to predict stock change after 15 mins and then
#   trade accordingly.
#
"""
...
def on_ticks(ws, ticks):
    ...
    # First time the stocks are pre-selected the day before
    # load that list and then trade them,
    # some checks are there to look for errors
    if startup_code:
