...
As an original thinker, you do not want to reuse any of Lydia's moves. Specifically,
 if her path includes a unit move from some cell A to some adjacent cell B,
  your path cannot also include a move from A to B. (However, in that case,
   it is OK for your path to visit A or visit B, as long as you do not go from A to B.)
...
for i in range(1, t + 1):
  ...
  for letter in direction:
      if letter is 'S':
          ...
          direction_new += 'S'
  print("Case #{}: {}".format(i, direction_new))